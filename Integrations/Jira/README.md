...
|Username|None|False|String|None|
...
|Status|Specify the relevant transition name, to transition this issue to the new desired status.|False|String||
|Summary|The new summary of the issue|False|String||
|Description|The new description of the issue|False|String|None|
...
|Issue Types|The issue types to filter by|False|String|Bug|
...
|Days Backwards|Max number of days backwards to pull alerts from|False|Int|5|
|Max Tickets Per Cycle|Max tickets to fetch and process in one connector cycle|False|Int|10|
